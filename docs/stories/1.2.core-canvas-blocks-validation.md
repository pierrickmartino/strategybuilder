...
- Added a dedicated validation blockers panel so quota and dangling-edge issues surface without node context.
- Introduced revert success feedback to align UX with automation expectations.
- Expanded integration and e2e coverage for global issues and revert notifications.
